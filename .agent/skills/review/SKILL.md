...
After completing all three layers, produce a clear report. Do not bury issues. Do not soften them. 
Report honestly using the Antigravity `walkthrough.md` Artifact so the developer can review it clearly. Use GitHub-style alerts (e.g., `> [!WARNING]`) for critical or important issues.
