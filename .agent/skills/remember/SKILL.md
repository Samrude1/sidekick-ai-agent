...
Do not scan or read other files beyond this list unless requested. In Antigravity IDE, also keep in mind you can read the `conversation_transcript` if you need extreme detail from past steps, but usually the context files are enough.
